...
- **“Building Virtual Machine Labs: A Hands-on Guide (Second Edition)” by Tony Robinson** – [https://leanpub.com/avatar2](https://leanpub.com/avatar2)
...
- **Windows Evaluation Center** – [https://www.microsoft.com/en-us/evalcenter/evaluate-lab-kit](https://www.microsoft.com/en-us/evalcenter/evaluate-lab-kit)

## Tutorial websites

These websites provide tutorials and training opportunities. Some are free to use, while some are “pay to play.”

- **Securitytube.net** – [http://www.securitytube.net/](http://www.securitytube.net/)
- **cybrary.it** – [https://www.cybrary.it/](https://www.cybrary.it/)
...
- **TryHackMe** – [https://tryhackme.com/login](https://tryhackme.com/login)
- **MicroCorruption (Embedded Security CTF)** – [https://microcorruption.com](https://microcorruption.com)
- **UndertheWire (PowerShell specific training)** – [https://www.underthewire.tech/index.htm](https://www.underthewire.tech/index.htm)
...
- **BSides Atlanta (Discord)** – [https://bit.ly/bsidesatl-discord](https://bit.ly/bsidesatl-discord)
- **Atlanta Cybersecurity Engineers (Discord)** – [https://bit.ly/atlseceng](https://bit.ly/atlseceng)
- **Dr. Green's Security Community (Discord)** – [https://bit.ly/green-infosec-discord](https://bit.ly/green-infosec-discord)
