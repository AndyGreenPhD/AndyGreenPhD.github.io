...
These vulnerabilities cannot be patched, as they reside inside the CPU itself - this is a design flaw. If you read the solution section of [yesterday’s CERT update](https://www.kb.cert.org/vuls/id/584653), you’ll see that the only way to remove the vulnerability is to replace your chip.
